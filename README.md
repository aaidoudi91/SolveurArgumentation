...
optimisée (mapping d'entiers, bitsets) et des algorithmes de recherche (backtracking avec labelling et élagage).
...
│   ├── Utilitaires.hpp           # Primitives sémantiques (Sans-conflit, Défense...)
